...
<!--      </el-form-item>-->
      ...
      <el-form-item label="开户银行名称" prop="supplierBankName">
        <el-input v-model="dataForm.supplierBankName" placeholder="供应商开户银行名称"></el-input>
      </el-form-item>
      <el-form-item label="开户银行账号" prop="supplierBankAccount">
        <el-input v-model="dataForm.supplierBankAccount" placeholder="供应商开户银行账号"></el-input>
      </el-form-item>
...
<!--        <el-radio v-model="dataForm.supplierStatus" label="0">禁用</el-radio>-->
<!--        <el-radio v-model="dataForm.supplierStatus" label="1">启用</el-radio>-->
<!--      </el-form-item>-->
    </el-form>
