      ...
      <div style="height:260px">
        <el-form inline label-width="100px">
          ...
          <el-form-item label="目的">
            <el-input placeholder="" v-model="check1.purpose"></el-input>
          </el-form-item>
          <el-form-item label="要求">
            <el-input placeholder="" v-model="check1.requirements"></el-input>
          </el-form-item>
          <el-form-item label="临床印象">
            <el-input placeholder="" v-model="check1.clinicalImpression"></el-input>
          </el-form-item>
          <el-form-item label="临床诊断">
            <el-input placeholder="" v-model="check1.clinicalDiagnosis"></el-input>
          </el-form-item>
          <el-form-item label="检查部位">
            <el-input placeholder="" v-model="check1.checkThe"></el-input>
          </el-form-item>
        </el-form>
    ...
    methods: {
      ...
      apply() {
        ...
        this.$http({
          ...
          method: 'post',
          data: this.$http.adornData({'list':this.check1,'patientId':this.patient.patientId,'registerId':this.registerId})
        }).then(({data}) => {
