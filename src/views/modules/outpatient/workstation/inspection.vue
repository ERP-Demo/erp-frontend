            ...
            <div style="height:260px">
                <el-form inline label-width="100px">
                    <el-form-item label="项目编码">
                        <el-input disabled placeholder="" v-model="check.testSynthesizeId"></el-input>
                    </el-form-item>
                    <el-form-item label="项目名称">
                        <el-input disabled placeholder="" v-model="check.testSynthesizeName"></el-input>
                    </el-form-item>
                    <el-form-item label="目的">
                        <el-input placeholder="" v-model="check.purpose"></el-input>
                    </el-form-item>
                    <el-form-item label="要求">
                        <el-input placeholder="" v-model="check.requirements"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="检查部位">
                        <el-input placeholder="" v-model="check.checkThe"></el-input>
                    </el-form-item>
                </el-form>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitDemand() {
                this.record.map(item =>{
                    if (item.testSynthesizeId===this.check.testSynthesizeId){
                        item.purpose = this.check.purpose
                        item.requirements = this.check.requirements
                        item.clinicalImpression = this.check.clinicalImpression
                        item.clinicalDiagnosis = this.check.clinicalDiagnosis
                        item.checkThe = this.check.checkThe
                    }
                })
